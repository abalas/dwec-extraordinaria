...
const Login = () => {
  ...
  const { signIn, signUp, entrarModoPruebas } = useAuth();
  const navigate = useNavigate();

  //////////////////////////////////////
  // ACCESO RÁPIDO (MODO PRUEBAS)
  // Entra SIN contraseña y SIN internet: crea un usuario falso en el contexto
  // y nos lleva directos a /admin. Solo para hacer pruebas rápidas.
  //////////////////////////////////////
  const accesoRapido = () => {
    entrarModoPruebas();
    navigate('/admin');
    ...
    <div className="login-container">
      <div className="login-card">
        ...
        <div className="login-footer">
          ...
          {/* Acceso rápido SIN contraseña y SIN internet (solo para pruebas) */}
          <button
            type="button"
            onClick={accesoRapido}
            className="acceso-rapido-button"
          >
            🔓 Entrar sin contraseña (modo pruebas)
          </button>
        </div>
      </div>
    </div>
